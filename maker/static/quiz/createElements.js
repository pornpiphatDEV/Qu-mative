...
function createQuestionLabelAndInput(q_inp_value) {
    ...
    select.onchange = function () {
        ...
        if (text === 'จำ') {
            q_inp.value = "สามารถบอกชื่อ........ ได้หรือไม่"
        }
        else if (text === 'เข้าใจ') {
            q_inp.value = " ใจความสำคัญของ...คืออะไร"
        }
        else if (text === 'ประยุกต์ใช้') {
            q_inp.value = "สามารถประยุกต์วิธีการที่ใช้เข้ากับประสบการณ์ของตนเองในด้าน.....ได้หรือไม่"
        }
        else if (text === 'ประเมินค่า') {
            q_inp.value = "มีวิธีการกี่วิธีที่สามารถ......."
        }
        else if (text === 'วิเคราะห์') {
            q_inp.value = "สามารถอธิบายได้หรือไม่ หาก......."
        }
        else if (text === 'สร้างสรรค์') {
            q_inp.value = " "
        }
